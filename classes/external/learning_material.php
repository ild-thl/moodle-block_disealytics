...
/**
 * Web service to handle learning materials.
 *
 ...
 */
class learning_material extends external_api {
    /**
    ...
    public static function execute(
        ...
        if ($calltype === 'add') {
            learningdata::write_learning_material($data);
        } else if ($calltype === 'update') {
            learningdata::update_learning_material($data);
        } else if ($calltype === 'delete') {
            learningdata::delete_learning_material($id);
        }
        return true;
    }
