...
Auf dem gesamten Dashboard befindet sich ein Hilfe-Symbol, das durch ein <span style="color:var(--primary)">“?”-Icon</span> dargestellt wird. Dieses Icon bietet Nutzern schnellen Zugang zu kontextbezogener Unterstützung und Erklärungen zur Funktionsweise des Dashboards.
...
$string['statistic-insights-view_course_not_available']= '<span style="color: var(--gray);"><i class="fa fa-warning"></i> Es sind keine Vorhersagen über Ihren aktuellen Fortschritt in diesem Kurs verfügbar oder wurden von der administrierenden Person nicht veranlasst.</span>';
