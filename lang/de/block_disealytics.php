...
$string['assignment-view_help_info_text'] = "<p>Die Karte \"Aufgaben\" listet alle Aufgaben des Kurses auf, die Ihnen zur Verfügung stehen und zeigt einen aktuellen Status der Aufgabe. Wenn Sie auf den Link zu einer Aufgabe klicken, gelangen Sie auf die Seite mit den Details zu dieser Aufgabe.</p> <p style='color: var(--bs-primary)'>Symbolbedeutung:</p> <p> <span style='color: var(--bs-primary)'>Neutraler Status (Grauer Kreis):</span> Der grau ausgefüllte Kreis steht für einen neutralen Status der Aufgabe. Hier besteht kein Handlungsbedarf. <p> <span style='color: var(--bs-primary)'>Nicht bestanden (Rotes 'X')</span> Das rote  \"X\" weist darauf hin, dass die entsprechende Aufgabe bewertet, aber nicht bestanden wurde. Für weitere Details klicken Sie bitte auf den Link der Aufgabe. <p> <span style='color: var(--bs-primary)'>  Noch nicht bearbeitet (Graues \"X\"):</span> Das graue \"X\" weist darauf hin, dass die entsprechende Aufgabe noch nicht abgegeben / bearbeitet wurde. Für weitere Details klicken Sie bitte auf den Link der Aufgabe. <p><span style='color: var(--bs-primary)'>Unvollständig (Gelbes Warnzeichen):</span> Das gelbe Warnzeichen zeigt an, dass die Aufgabe unvollständig ist, die Aufgabe noch nicht bearbeitet werden kann, weil noch Voraussetzungen fehlen oder gegebenenfalls nach dem Fälligkeitsdatum abgegeben wurde. Außerdem kann es sein, dass die Aufgabe zwar nicht bestanden wurde, aber noch weitere Versuche möglich sind. Für weitere Details klicken Sie bitte auf den Link der Aufgabe.  <p><span style='color: var(--bs-primary)'>Rechtzeitig abgegeben (Grauer Pfeil):</span> Der graue Pfeil weist darauf hin, dass eine rechtzeitige Abgabe erfolgt ist. Für weitere Details klicken Sie bitte auf den Link der Aufgabe. <p> <span style='color: var(--bs-primary)'>Unvollstaendig/Warnung (Gelbes Warnzeichen):</span> Das gelbe Warnzeichen zeigt an, dass die Aufgabe unvollständig ist, die Aufgabe noch nicht bearbeitet werden kann, weil noch Voraussetzungen fehlen oder gegebenenfalls nach dem Fälligkeitsdatum abgegeben wurde. Außerdem kann es sein, dass die Aufgabe zwar nicht bestanden wurde, aber noch weitere Versuche möglich sind. Für weitere Details klicken Sie bitte auf den Link der Aufgabe.  <p> <span style='color: var(--bs-primary)'>Rechtzeitig abgegeben (Grauer Pfeil): </span> Der graue Pfeil weist darauf hin, dass eine rechtzeitige Abgabe erfolgt ist. Für weitere Details klicken Sie bitte auf den Link der Aufgabe. <p> <span style='color: var(--bs-primary)'> Selbst als erledigt markiert (Gelber Pfeil): </span> Der gelbe Pfeil weist darauf hin, dass die Aufgabe vom Studierenden selbst als erledigt markiert wurde, aber gegebenenfalls noch vom Lehrenden überprüft werden muss. Für weitere Details klicken Sie bitte auf den Link der Aufgabe. <p><span style='color: var(--bs-primary)'>Bestanden (Grüner Pfeil): </span> Der grüne Pfeil weist darauf hin, dass die Aufgabe bestanden ist. Für weitere Details klicken Sie bitte auf den Link der Aufgabe.";
...
$string['progress-bar-view_help_info_text'] = '<p>Der Lesefortschrittsbalken zeigt Ihnen den Lesefortschritt Ihrer aktuellen Lektüre.</p><p style="color: var(--bs-primary)">Hinzufügen von Lernmaterialien</p><p>In der Standardeinstellung ist die Karte leer. Sie können dieser Karte den Fortschritt der Lernmaterialien dieses Kurses über das Zahnrad rechts oben in der Karte hinzufügen.</p><p style="color: var(--bs-primary)">Grafikdaten anzeigen</p><p>Dies zeigt Ihnen eine detaillierte Tabelle mit den Lernmaterialien, die Sie eingegeben haben, an.';
...
Auf dem gesamten Dashboard befindet sich ein Hilfe-Symbol, das durch ein <span style="color:var(--bs-primary)">“?”-Icon</span> dargestellt wird. Dieses Icon bietet Nutzern schnellen Zugang zu kontextbezogener Unterstützung und Erklärungen zur Funktionsweise des Dashboards.
...
// Main help cards.
$string['main_help_assignment-view'] = 'Die Karte <span style="color:var(--bs-primary)">Aufgabenübersicht</span> listet alle Einsendeaufgaben auf, die Ihnen in den entsprechenden Modulen zur Verfügung stehen und zeigt einen aktuellen Status der Aufgabe.';
$string['main_help_activity-view'] = 'Die Karte <span style="color:var(--bs-primary)">Nutzungsaktivität</span> betrachtet Ihre Lernzeit auf einen Blick! Die farbigen Segmente repräsentieren unterschiedliche Aktivitäten und ihre Höhe zeigt die Dauer jeder Aktivität.';
$string['main_help_learning-goals-view'] = 'In der Karte <span style="color:var(--bs-primary)">Lernziele</span> können Sie jegliche Lernziele festhalten. Diese Funktion können Sie auch Semesterübergreifend verwenden.';
$string['main_help_planner-view'] = 'Diese Karte <span style="color:var(--bs-primary)">Planungsassistent</span> zeigt Ihnen einen Überblick über Ihre anstehenden Webkonferenzen, Einsendeaufgaben oder andere Aktivitäten.';
$string['main_help_progress-bar-view'] = 'In der Karte <span style="color:var(--bs-primary)">Lesefortschrittsbalken</span> können Sie manuell Lernmaterialien hinzufügen und erhalten in Form eines Diagramms den aktuellen Lesefortschritt Ihrer aktuellen Lektüre.';
$string['main_help_study-progress-view'] = 'Das Speedometer in der Karte <span style="color:var(--bs-primary)">Lernfortschrittsanzeige</span> zeigt Ihnen Ihren Lernfortschritt an und stellt dar, wie weit Sie auf dem Weg zum Ziel sind. Die Grundlage der Berechnung sind die Bewertungen in den Aufgaben, die für Sie im Kurs zugeordnet sind.';
$string['main_help_success-chance-view'] = 'In der Karte <span style="color:var(--bs-primary)">PVL-Wahrscheinlichkeit</span> werden alle Einsendeaufgaben (inkl. Bewertungspunkte) dargestellt. Die jeweilige PVL-Wahrscheinlichkeit errechnet sich aus den Bewertungspunkten der einzelnen Abgaben und stellt diese als Prozentsatz dar.';
...
<p style="color: var(--bs-primary)">Risikostatus:</p>
<p>
...
<p style="color: var(--bs-primary)">Informationen zum Kursabschluss:</p>
<p>
    Wenn die Verfolgung des Kursabschlusses aktiviert ist, zeigt die Karte den aktuellen Fortschritt und Kriterien an.
</p>
<p style="color: var(--bs-primary)">Allgemeine Engagement-Metriken:</p>
<p>
...
<p style="color: var(--bs-primary)">Modul-spezifische Einblicke:</p>
<p>
...
$string['study-progress_infotext_average'] = 'Der Lernfortschritt ist momentan <span style="color: var(--bs-primary)">mittelmäßig</span>.';
