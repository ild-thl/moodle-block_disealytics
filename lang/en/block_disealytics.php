...
$string['assignment-view_help_info_text'] = "<p>The 'Assignments' card lists all the assignments of the course available to you and shows the current status of the assignment. When you click on the link of an assignment, you will be forwarded to the page with the details of that assignment.</p> <p style='color: var(--bs-primary)'>Symbol meanings:</p> <p> <span style='color: var(--bs-primary)'>Neutral status (grey circle):</span> The grey circle represents the neutral status of the assignment. No action is required. <p> <span style='color: var(--bs-primary)'>Not passed (red 'X'):</span> The red 'X' indicates that the respective assignment has been assessed but not passed. For more details, please click on the assignment link. <p> <span style='color: var(--bs-primary)'>Not yet attempted (grey 'X'):</span> The grey 'X' indicates that the respective assignment has not yet been submitted / attempted. For more details, please click on the assignment link. <p><span style='color: var(--bs-primary)'>Incomplete (yellow warning sign):</span> The yellow warning sign indicates that the assignment is incomplete, cannot be attempted yet because of missing requirements, or may have been submitted after the due date. Additionally, it may indicate that the assignment has not been passed but further attempts are possible. For more details, please click on the assignment link.  <p><span style='color: var(--bs-primary)'>Submitted on time (grey check mark):</span> The grey check mark indicates that the submission was made on time. For more details, please click on the assignment link. <p> <span style='color: var(--bs-primary)'>Incomplete/Warning (yellow warning sign):</span> The yellow warning sign indicates that the assignment is incomplete, cannot be attempted yet because of missing requirements, or may have been submitted after the due date. Additionally, it may indicate that the assignment has not been passed but further attempts are possible. For more details, please click on the assignment link.  <p> <span style='color: var(--bs-primary)'>Submitted on time (Grey check mark): </span> The grey check mark indicates that the submission was made on time. For more details, please click on the assignment link. <p> <span style='color: var(--bs-primary)'>Marked as completed by yourself (Yellow check mark): </span> The yellow check mark indicates that the assignment has been self-marked as complete by the student, but may still need to be reviewed by the instructor. For more details, please click on the assignment link. <p><span style='color: var(--bs-primary)'>Passed (Green check mark): </span> The green check mark indicates that the assignment was passed. For more details, please click on the assignment link.";
...
$string['progress-bar-view_help_info_text'] = "<p>The 'Progressbar' card shows you the reading progress of your current learning material.</p><p style='color: var(--bs-primary)'>Add learning material</p><p>By default, the card is empty. You can add the progress of learning materials belonging to this course to the card through the gear icon at the top right corner.</p><p style='color: var(--bs-primary)'>Viewing graphic data</p><p>This will show you a detailed table of the learning materials you have submitted.";
...
There is a help icon on the entire dashboard, which can be accessed via a <span style="color:var(--bs-primary)">“?”-Icon</span>. This icon provides users with quick access to context-related support and explanations of how the dashboard works.
...
// Main help cards.
$string['main_help_assignment-view'] = 'The card <span style="color:var(--bs-primary)">Assignments</span> lists all submission tasks that are available to you in the corresponding modules and shows the current status of the task.';
$string['main_help_activity-view'] = 'The card <span style="color:var(--bs-primary)">Activity</span> views your learning time at a glance! The coloured segments represent different activities and their height shows the duration of each activity.';
$string['main_help_learning-goals-view'] = 'In the card <span style="color:var(--bs-primary)">Learning Goals</span> you can record any learning objectives. You can also use this function across semesters.';
$string['main_help_planner-view'] = 'The card <span style="color:var(--bs-primary)">Planning Assistent</span> shows you an overview of your upcoming web conference, submission tasks or other activities.';
$string['main_help_progress-bar-view'] = 'In the card <span style="color:var(--bs-primary)">Progressbar</span> you can add learning materials manually and receive the current reading progress of your current reading in the form of a diagram.';
$string['main_help_study-progress-view'] = 'The speedometer on the card <span style="color:var(--bs-primary)">Study Progress</span> shows you your learning progress and how far you are towards your goal. The calculation is based on the assessments in the tasks that are assigned to you in the course.';
$string['main_help_success-chance-view'] = 'In the card <span style="color:var(--bs-primary)">PVL-Probability</span> all submissions (including assessment points) are displayed. The respective PVL probability is calculated from the assessment points of the individual submissions and displayed as a percentage.';
...
<p style='color: var(--bs-primary)'>Student Risk Status:</p>
<p>
...
<p style='color: var(--bs-primary)'>Course Completion Information:</p>
<p>
...
<p style='color: var(--bs-primary)'>General Engagement Metrics:</p>
<p>
...
<p style='color: var(--bs-primary)'>Module-Specific Insights:</p>
<p>
...
$string['study-progress_infotext_average'] = 'The study progress is currently <span style="color: var(--bs-primary)">average</span>.';
