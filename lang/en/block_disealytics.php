...
$string['statistic-insights-view_no_course_available'] = '<p style="color: var(--gray);"><i class="fa fa-warning"></i></p><p>You are not enrolled in a course in this semester for which statistical insights are available.</p>';
